function varargout = smpleVTmanipultorGUI(varargin)
% SMPLEVTMANIPULTORGUI MATLAB code for smpleVTmanipultorGUI.fig
%      SMPLEVTMANIPULTORGUI, by itself, creates a new SMPLEVTMANIPULTORGUI or raises the existing
%      singleton*.
%
%      H = SMPLEVTMANIPULTORGUI returns the handle to a new SMPLEVTMANIPULTORGUI or the handle to
%      the existing singleton*.
%
%      SMPLEVTMANIPULTORGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SMPLEVTMANIPULTORGUI.M with the given input arguments.
%
%      SMPLEVTMANIPULTORGUI('Property','Value',...) creates a new SMPLEVTMANIPULTORGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before smpleVTmanipultorGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to smpleVTmanipultorGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help smpleVTmanipultorGUI
...
% Last Modified by GUIDE v2.5 14-Jun-2014 11:57:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @smpleVTmanipultorGUI_OpeningFcn, ...
    'gui_OutputFcn',  @smpleVTmanipultorGUI_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before smpleVTmanipultorGUI is made visible.
function smpleVTmanipultorGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to smpleVTmanipultorGUI (see VARARGIN)

% Choose default command line output for smpleVTmanipultorGUI
...
% UIWAIT makes smpleVTmanipultorGUI wait for user response (see UIRESUME)
% uiwait(handles.VTmainpulatorGUI);
end

% --- Outputs from this function are returned to the command line.
function varargout = smpleVTmanipultorGUI_OutputFcn(hObject, eventdata, handles)
...
myGUIdata.shapeMagnifierSlideHandle = plot(-0.03*[1 1],[-3 3]);
myGUIdata.shapeMagnifierReference = 1.5;
myGUIdata.shapeMagnifierHandle = plot(-0.03,myGUIdata.shapeMagnifierReference,'s','linewidth',3,'markersize',10);
myGUIdata.shapeMagnifier = 1;
myGUIdata.shapeMagnifierFocusHandle = plot(-0.03,myGUIdata.shapeMagnifierReference,'o','markersize',20,'linewidth',3);
    ...
    case 'on'
        ...
        switch get(myGUIdata.VTmainpulatorGUI,'Pointer');
            case 'fullcrosshair'
                ...
                myGUIdata.rawCompositeModifier = ydata;
                set(myGUIdata.compositePlotHandle,'ydata',myGUIdata.rawCompositeModifier*myGUIdata.shapeMagnifier);
...
save(outStatusFileName,'modificationStructure');
end
