function exPram = extractPrameterForAttractivenessV02(x,fs)
...
%%For Version01 using canonicalVowelTemplateBasedVTLFast2
%{
...
y = hanningHPF(hanningHPF(hanningHPF(x,fs,70),fs,70),fs,70);
vtlStructure = textIndependentVTLKalman(y,fs);


%exPram.rvtl.evalConditionCn = evalConditionCn;
exPram.rvtl.distStr = vtlStructure;
