function refinedStr = refineExGxOutputRevSqx(x,fs,periodicityStructure,optStr)
%   refinedStr = refineExGxOutputRevSqx(x,fs,periodicityStructure)
...
for ii = 1:length(periodicityStructure.temporalPositions)
    rc = tandemGxF0RefineSqx(x,fs,periodicityStructure.temporalPositions(ii),...
