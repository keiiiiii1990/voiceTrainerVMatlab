function varargout = attractiveImproverDbg002(varargin)
% ATTRACTIVEIMPROVERDBG002 MATLAB code for attractiveImproverDbg002.fig
%      ATTRACTIVEIMPROVERDBG002, by itself, creates a new ATTRACTIVEIMPROVERDBG002 or raises the existing
%      singleton*.
%
%      H = ATTRACTIVEIMPROVERDBG002 returns the handle to a new ATTRACTIVEIMPROVERDBG002 or the handle to
%      the existing singleton*.
%
%      ATTRACTIVEIMPROVERDBG002('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATTRACTIVEIMPROVERDBG002.M with the given input arguments.
%
%      ATTRACTIVEIMPROVERDBG002('Property','Value',...) creates a new ATTRACTIVEIMPROVERDBG002 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before attractiveImproverDbg002_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to attractiveImproverDbg002_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help attractiveImproverDbg002

% Last Modified by GUIDE v2.5 15-Jan-2015 02:31:47

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @attractiveImproverDbg002_OpeningFcn, ...
                   'gui_OutputFcn',  @attractiveImproverDbg002_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before attractiveImproverDbg002 is made visible.
function attractiveImproverDbg002_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to attractiveImproverDbg002 (see VARARGIN)

% Choose default command line output for attractiveImproverDbg002
...
% UIWAIT makes attractiveImproverDbg002 wait for user response (see UIRESUME)
...
function varargout = attractiveImproverDbg002_OutputFcn(hObject, eventdata, handles) 
...
logArea = myGUIdata.crImpSoundStr.newLpcStructure.newLogAreaMatrix(ii,:);
cSec = tubeDisplay(logArea(:));
[X,Y,Z] = cylinder(cSec,40);
set(get(gca,'children'),'xdata',Z,'ydata',Y,'zdata',X,'visible','on');
