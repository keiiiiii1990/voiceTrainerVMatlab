function varargout = attractiveImproverV03test(varargin)
% ATTRACTIVEIMPROVERV03TEST MATLAB code for attractiveImproverV03test.fig
%      ATTRACTIVEIMPROVERV03TEST, by itself, creates a new ATTRACTIVEIMPROVERV03TEST or raises the existing
%      singleton*.
%
%      H = ATTRACTIVEIMPROVERV03TEST returns the handle to a new ATTRACTIVEIMPROVERV03TEST or the handle to
%      the existing singleton*.
%
%      ATTRACTIVEIMPROVERV03TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATTRACTIVEIMPROVERV03TEST.M with the given input arguments.
%
%      ATTRACTIVEIMPROVERV03TEST('Property','Value',...) creates a new ATTRACTIVEIMPROVERV03TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before attractiveImproverV03test_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to attractiveImproverV03test_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help attractiveImproverV03test

% Last Modified by GUIDE v2.5 08-Jan-2015 16:07:42

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @attractiveImproverV03test_OpeningFcn, ...
                   'gui_OutputFcn',  @attractiveImproverV03test_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before attractiveImproverV03test is made visible.
function attractiveImproverV03test_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to attractiveImproverV03test (see VARARGIN)

% Choose default command line output for attractiveImproverV03test
...
% UIWAIT makes attractiveImproverV03test wait for user response (see UIRESUME)
...
function varargout = attractiveImproverV03test_OutputFcn(hObject, eventdata, handles) 
