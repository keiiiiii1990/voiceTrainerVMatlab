function varargout = attractiveImproverDbg001(varargin)
% ATTRACTIVEIMPROVERDBG001 MATLAB code for attractiveImproverDbg001.fig
%      ATTRACTIVEIMPROVERDBG001, by itself, creates a new ATTRACTIVEIMPROVERDBG001 or raises the existing
%      singleton*.
%
%      H = ATTRACTIVEIMPROVERDBG001 returns the handle to a new ATTRACTIVEIMPROVERDBG001 or the handle to
%      the existing singleton*.
%
%      ATTRACTIVEIMPROVERDBG001('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATTRACTIVEIMPROVERDBG001.M with the given input arguments.
%
%      ATTRACTIVEIMPROVERDBG001('Property','Value',...) creates a new ATTRACTIVEIMPROVERDBG001 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before attractiveImproverDbg001_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to attractiveImproverDbg001_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help attractiveImproverDbg001

% Last Modified by GUIDE v2.5 14-Jan-2015 00:49:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @attractiveImproverDbg001_OpeningFcn, ...
                   'gui_OutputFcn',  @attractiveImproverDbg001_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before attractiveImproverDbg001 is made visible.
function attractiveImproverDbg001_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to attractiveImproverDbg001 (see VARARGIN)

% Choose default command line output for attractiveImproverDbg001
...
% UIWAIT makes attractiveImproverDbg001 wait for user response (see UIRESUME)
...
function varargout = attractiveImproverDbg001_OutputFcn(hObject, eventdata, handles) 
...
%OC = gray;
%OC = [0.49, 1, 0.83];
%myGUIdata.tract3DOrg = surf(Z,Y,X,OC);
