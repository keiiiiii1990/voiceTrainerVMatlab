function varargout = attractiveImproverV401(varargin)
% ATTRACTIVEIMPROVERV401 MATLAB code for attractiveImproverV401.fig
%      ATTRACTIVEIMPROVERV401, by itself, creates a new ATTRACTIVEIMPROVERV401 or raises the existing
%      singleton*.
%
%      H = ATTRACTIVEIMPROVERV401 returns the handle to a new ATTRACTIVEIMPROVERV401 or the handle to
%      the existing singleton*.
%
%      ATTRACTIVEIMPROVERV401('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATTRACTIVEIMPROVERV401.M with the given input arguments.
%
%      ATTRACTIVEIMPROVERV401('Property','Value',...) creates a new ATTRACTIVEIMPROVERV401 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before attractiveImproverV401_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to attractiveImproverV401_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help attractiveImproverV401

% Last Modified by GUIDE v2.5 13-Jan-2015 10:15:44

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @attractiveImproverV401_OpeningFcn, ...
                   'gui_OutputFcn',  @attractiveImproverV401_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before attractiveImproverV401 is made visible.
function attractiveImproverV401_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to attractiveImproverV401 (see VARARGIN)

% Choose default command line output for attractiveImproverV401
...
% UIWAIT makes attractiveImproverV401 wait for user response (see UIRESUME)
...
function varargout = attractiveImproverV401_OutputFcn(hObject, eventdata, handles) 
...
ii = floor((currentPoint-myGUIdata.VtafStruct.lpcStructure.windowLengthInMs)/floor(fs*0.001));
...
ii = floor((currentPoint-myGUIdata.crImpSoundStr.newLpcStructure.lpcStructure.windowLengthInMs)/floor(fs*0.001));
