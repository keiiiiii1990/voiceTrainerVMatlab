function varargout = attractiveImproverV02(varargin)
% ATTRACTIVEIMPROVERV02 MATLAB code for attractiveImproverV02.fig
%      ATTRACTIVEIMPROVERV02, by itself, creates a new ATTRACTIVEIMPROVERV02 or raises the existing
%      singleton*.
%
%      H = ATTRACTIVEIMPROVERV02 returns the handle to a new ATTRACTIVEIMPROVERV02 or the handle to
%      the existing singleton*.
%
%      ATTRACTIVEIMPROVERV02('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATTRACTIVEIMPROVERV02.M with the given input arguments.
%
%      ATTRACTIVEIMPROVERV02('Property','Value',...) creates a new ATTRACTIVEIMPROVERV02 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before attractiveImproverV02_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to attractiveImproverV02_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help attractiveImproverV02

% Last Modified by GUIDE v2.5 06-Jan-2015 00:20:40

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @attractiveImproverV02_OpeningFcn, ...
                   'gui_OutputFcn',  @attractiveImproverV02_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before attractiveImproverV02 is made visible.
function attractiveImproverV02_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to attractiveImproverV02 (see VARARGIN)

% Choose default command line output for attractiveImproverV02
...
% UIWAIT makes attractiveImproverV02 wait for user response (see UIRESUME)
...
function varargout = attractiveImproverV02_OutputFcn(hObject, eventdata, handles) 
